...
const (
	...
	PayloadTypeThreadGetInfo                   payloadType = 1200
	PayloadTypeThreadStateInfo                 payloadType = 1201
)
...
var Payloads = map[uint16]func() Payload{
	...
	1200: func() Payload { return &ThreadGetInfo{} },
	1201: func() Payload { return &ThreadStateInfo{} },
}
